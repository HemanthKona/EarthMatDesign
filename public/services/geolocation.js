/* 
	geolocation.js
	Get the current geolocation using HTML5 geolocation api

	Revision history
	Hemanth Kona, 2014.07.20: created
 */
...
app.factory('geolocation', ['$q','$rootScope','$window','geolocation_msgs',function ($q,$rootScope,$window,geolocation_msgs) {
    return {
